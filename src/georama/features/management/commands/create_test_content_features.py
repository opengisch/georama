...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        FeatureLayerFactory.create(
            ...
            datasource=vector,
            metadata=MetadataFactory(title="TestFeatureLayer"),
        )
