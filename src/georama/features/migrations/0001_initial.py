        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    ...
                    models.UUIDField(
                        default=uuid.uuid4,
                        help_text="Identifier of the feature layer.",
                        primary_key=True,
                        serialize=False,
                    ),
                ),
                ...
                (
                    ...
                    models.IntegerField(
                        default=10,
                        help_text="The default number of features that should be returned for the layer.",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.IntegerField(
                        default=500,
                        help_text="The maximum number of features that may be returned for the layer.",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        default="ERROR",
                        help_text="Whether the server should return an error or cap the value when more thanmax_items are requested",
                        max_length=10,
                        null=True,
                    ),
                ),
                (
                    "datasource",
                    models.ForeignKey(
                        help_text="Datasource the feature layer points to.",
                ...
                (
                    ...
                    models.OneToOneField(
                        help_text="Metadata of the feature layer.",
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="feature_layer",
                        to="features.metadata",
                    ),
                ),
            ],
            options={
                ...
                "permissions": [
                    ...
                    (
                        ...
                        "Can view items on published layer",
                    ),
                    (
