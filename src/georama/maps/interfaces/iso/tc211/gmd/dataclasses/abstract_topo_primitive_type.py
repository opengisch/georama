...
class Isolated(IsolatedPropertyType):
    """
    The gml:isolated property element implements the role of the same name of the
...
class Container(ContainerPropertyType):
    """
    The gml:container property element implements the role of the same name of the
    ISO 19107 “Isolated In” association (see ISO 19107:2003, 7.3.10.4).
    """
