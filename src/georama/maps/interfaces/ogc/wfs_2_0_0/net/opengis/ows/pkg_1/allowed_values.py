...
from georama.maps.interfaces.ogc.wfs_2_0_0.net.opengis.ows.pkg_1.range import Range
from georama.maps.interfaces.ogc.wfs_2_0_0.net.opengis.ows.pkg_1.value import Value
